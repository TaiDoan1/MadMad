...
// Các nav items - path từ root "/" vì Admin Dashboard là standalone app
const navItems = [
  { path: "/", icon: LayoutDashboard, label: "Tổng quan" },
  { path: "/storefront", icon: Monitor, label: "Giao diện" },
  ...
  { path: "/inventory", icon: ClipboardList, label: "Tồn kho" },
  { path: "/membership", icon: ShieldCheck, label: "Hội viên VIP" },
        ...
        >
          <div>
            <div className="flex items-center justify-between border-b border-border p-4">
              ...
              <button type="button" onClick={() => setSidebarOpen((v) => !v)} aria-label="Thu gọn sidebar">
        ...
        <main className="min-w-0 flex-1">
          <header className="sticky top-0 z-30 border-b border-border bg-white p-3 md:p-4">
            <div className="flex w-full items-center gap-3">
              ...
              <h2 className="text-base font-semibold md:text-xl">MADMAD Admin Dashboard</h2>
            </div>
          </header>
