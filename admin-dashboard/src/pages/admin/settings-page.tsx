    ...
    <div className="mx-auto max-w-4xl space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <Link to="/storefront" className="rounded-xl border border-black/15 bg-white px-4 py-2.5 text-xs font-bold tracking-widest uppercase transition-colors hover:bg-stone-50">
            Storefront Settings
          </Link>
        </div>
      </div>
